...
![Стартовый экран чата: примеры вопросов, поле ввода, скрепка и отправка](assets/01-start.png)
...
![Ответ на запрос наличия с карточкой товара](assets/02-stock.png)
...
![Отсутствующий товар и начало списка аналогов](assets/03-analogs.png)
...
![Ответ консультанта об условиях покупки](assets/04-terms.png)
...
![Предложение добавить товар с кнопками подтверждения и отказа](assets/05-cart.png)
...
Нажмите скрепку рядом с полем ввода и выберите файл. Можно начать с [примера спецификации](assets/spec-example.csv), приложенного к руководству.
...
- `assets/` — пять иллюстраций из репозитория;
- `assets/spec-example.csv` — пример файла для загрузки.

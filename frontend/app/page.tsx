...
const STEPS = [
  {
    ...
    body: "Нажмите «Запустить ИИ-ассистента» в баннере или кнопку «Консультант» в правом нижнем углу. Ассистент поздоровается и предложит готовые вопросы: наличие по артикулу, поиск по названию и условия покупки. Скрепка внизу чата принимает спецификацию .csv или .xlsx — наличие проверяется по каждой строке.",
  },
  {
  ...
  },
  {
    ...
    body: "Вопрос «Какие условия доставки и оплаты?» возвращает условия из справочника магазина: бесплатная доставка по Алматы от 15 000 ₸, пороги по городам, оплата для физлиц и юрлиц, срок доставки после согласования с менеджером.",
  },
  {
